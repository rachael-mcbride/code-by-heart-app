    ...
    <div className="two-sections">
      <div className="section1">
        ...
        <div className="section1-body">
          ...
          <span>It allows you to <b>create</b>, <b>execute</b>, and <b>save flashcards</b> in a particular programming language, and then later review these cards at optimally-spaced intervals—hence helping you code <a href="https://dictionary.cambridge.org/us/dictionary/english/by-heart" target="_blank">by heart</a>.</span>
        </div>
